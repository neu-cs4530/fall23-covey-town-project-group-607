  ...
  describe('[T1.1]', () => {
    ...
    describe('guesses', () => {
      it('should return an empty list of guesses by default', () => {
        ...
        expect(controller.guessCount).toEqual(0);
      });
    });
    describe('player 1', () => {
    ...
    describe('player2', () => {
      it('should return player 2 if there is one', () => {
        const controller = hangmanGameAreaControllerWithProp({
          status: 'IN_PROGRESS',
          player1: otherPlayers[0].id,
          player2: ourPlayer.id,
      ...
      it('should return undefined if there is no player 2 and the game is waiting to start', () => {
        const controller = hangmanGameAreaControllerWithProp({
          status: 'WAITING_TO_START',
        });
        expect(controller.player2).toBe(undefined);
      });
      it('should return undefined if there is no player 2', () => {
        const controller = hangmanGameAreaControllerWithProp({
          status: 'IN_PROGRESS',
          player1: otherPlayers[0].id,
        });
    ...
    describe('player4', () => {
      it('should return the player 4 if there is one', () => {
        const controller = hangmanGameAreaControllerWithProp({
          status: 'IN_PROGRESS',
          player1: otherPlayers[0].id,
          player2: otherPlayers[1].id,
    ...
    describe('winners', () => {
      it('should return the winners if there is one', () => {
        ...
        expect(controller.winner).toStrictEqual(winners);
      });
  ...
  describe('[T1.2] _updateFrom', () => {
    describe('if the game is in progress', () => {
      ...
      it('should emit a boardChanged event with the new board', () => {
        ...
        expect(spy).toHaveBeenCalledWith('boardChanged', controller.currentGuess);
      });
